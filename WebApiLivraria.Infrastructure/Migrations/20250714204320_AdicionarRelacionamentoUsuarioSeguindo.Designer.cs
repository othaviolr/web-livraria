...
namespace WebApiLivraria.Infrastructure.Migrations
{
    ...
    [Migration("20250714204320_AdicionarRelacionamentoUsuarioSeguindo")]
    partial class AdicionarRelacionamentoUsuarioSeguindo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApiLivraria.Domain.Entities.UsuarioSeguindo", b =>
                {
                    ...
                    b.ToTable("UsuariosSeguindo", (string)null);
                });
            ...
            modelBuilder.Entity("WebApiLivraria.Domain.Entities.UsuarioSeguindo", b =>
                {
                    b.HasOne("Usuario", "Seguidor")
                        .WithMany("Seguindo")
                        .HasForeignKey("SeguidorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Usuario", "Seguindo")
                        .WithMany("Seguidores")
